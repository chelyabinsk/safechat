...
struct LocaleFile {
    ...
    open_profile_directory: String,
    open_chat_history_directory: String,
    delete_chat: String,
...
impl From<LocaleFile> for UiText {
    fn from(value: LocaleFile) -> Self {
        Self {
            ...
            open_data_directory: value.open_data_directory.into(),
            open_profile_directory: value.open_profile_directory.into(),
            open_chat_history_directory: value.open_chat_history_directory.into(),
